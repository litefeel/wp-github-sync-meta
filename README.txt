...
2. Extract the `wp-github-sync-meta.zip` directory to your computer
3. Upload the `wp-github-sync-meta.zip` directory to the `/wp-content/plugins/` directory
...
* Initial release
  ...
  [1.0.0]: https://github.com/lite3/wp-github-sync-meta/releases/tag/1.0.0
